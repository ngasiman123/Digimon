...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2019 at 04:41 PM
...
(1, 1, 'login.png', 'main_menu.png', '1', 'ok siap', '2019-09-02 00:00:00', NULL, NULL, 14, NULL, NULL);
...
(1, 5, 'c-version 1', '1', 'mainmenu.png', 'test treasure', '2019-09-02 00:00:00', NULL, NULL, 14, NULL, NULL);
...
(1, 1, '1', NULL, 'approval cust', 'login.png', 'main_menu.png', '2019-09-02 00:00:00', NULL, NULL, 14, NULL, NULL);
...
INSERT INTO `request_details` (`request_detail_id`, `request_header_id`, `customer_info_no`, `sakura_ref_no`, `brand_code`, `warehouse_code`, `manufacture_code`, `order_qty`, `item_images`) VALUES
(1, 1, '23.100.3344', 'C-1123', 'B01', '001', '001', 100, 'login.png'),
(2, 1, '23.100.3345', 'C-1124', 'B01', '001', '001', 1000, 'main_menu.png'),
(3, 2, '222', 'C-1123', 'B02', 'MTK', '002', 10000, 'login.png'),
(4, 2, '111111', 'C-1124', NULL, NULL, '002', 1000, 'main_menu.png'),
(5, 3, '111111', 'C-1123', 'B01', 'MTK', '007', 10, 'main_menu.png');
...
('1567427815', 1, 'CX0001', '2019-09-02', 'PO12345', '2019-09-02 00:00:00', NULL, NULL, 14, NULL, NULL),
('1567427853', 2, 'C001', '2019-09-02', 'PO1212', '2019-09-02 00:00:00', NULL, NULL, 14, NULL, NULL),
('1567427895', 3, 'CX0001', '2019-09-02', 'PO1122', '2019-09-02 00:00:00', NULL, NULL, 14, NULL, NULL);
...
--
ALTER TABLE `bill_of_materials`
  MODIFY `bom_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `packagings`
  MODIFY `packaging_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `request_approves`
--
ALTER TABLE `request_approves`
  MODIFY `request_approve_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `request_details`
--
ALTER TABLE `request_details`
  MODIFY `request_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `request_headers`
--
ALTER TABLE `request_headers`
  MODIFY `request_header_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
